...
<label>Adm Number:</label>
  <input type="text" size="30"  name="txtadm_no"/>
</p>
<p>
<label>Event Name : </label>   
  <input type="text" size="30"name="txteventname" />
</p>
<p>
<label>Date:   </label><input type="text" size="30" name="txtdate"  />
</p>
<p>
<label>Time:</label><input type="text" size="30" name="txttime">
</p>
<p>
<label>Venue:</label><input type="text" size="30" name="txtvenue">
</p>
<p> 
