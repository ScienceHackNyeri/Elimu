...
if(isset($_POST['submit'])){
	...
	$details=$_POST['details'];
		...
		$q4="INSERT INTO updates(Admision_No,Event_Name,Date,Venue,Details) 
		VALUES('".$admno."','".$eventname."','".$date."','".$venue."','".$details."')";
...
<div class="head">
  <img src="Images/logo.png" style="height:100px; margin-left:45%; margin-top:10px; -moz-border-radius:10px; border-bottom:2px #FF0000 outset; border-left: #FF0000 2px outset; border-right:2px #003300 outset; border-top:#003300 2px solid; box-shadow: 4px 3px 5px 5px  green;" />
        ...
        <div id="content" style="background-color:lightyellow;">
...
<div style="background-color:lightgrey;margin-right:300px;margin-left:300px;">
...
<tr>
<td>
<label>Date:   </label></td><td><input type="text" size="30" name="date"  />
</td></tr>
<tr>
<td><label>Time:</label></td><td><input type="text" size="30" name="time">
</td></tr>
<tr>
<td>
<label>Venue:</label></td><td><input type="text" size="30" name="venue">
</td></tr>
<tr> 
<td><label>Details :</label>  </td><td> <textarea name="details"></textarea> 
